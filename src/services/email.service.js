...
async function sendTransactionFailureEmail(userEmail, name, amount, toAccount) {
  ...
  const html = `<p>Hello ${name},</p><p>We regret to inform you that your transaction of $${amount} to account ${toAccount} has failed.</p><p>Please try again later or contact support for assistance.</p><p>Best regards,<br>The Backend Ledger Team</p>`
